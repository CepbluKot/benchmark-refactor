...
class ClickHouseCelerySettingsTests(unittest.TestCase):
    ...
    def test_builds_broker_and_backend_from_rabbitmq_credentials(self) -> None:
        env = {
            "RABBITMQ_HOSTNAME": "rmq.local",
            "RABBITMQ_LOGIN": "bench_user",
            "RABBITMQ_PASSWORD": "bench_pass",
            "RABBITMQ_PORT": "5679",
        ...
        self.assertEqual(
            ...
            "rpc://bench_user:bench_pass@rmq.local:5679//",
        )
    ...
    def test_prefers_explicit_bench_urls_when_provided(self) -> None:
        env = {
            "RABBITMQ_HOSTNAME": "rmq.local",
            "RABBITMQ_LOGIN": "bench_user",
            "RABBITMQ_PASSWORD": "bench_pass",
    ...
    def test_default_guest_credentials_are_valid(self) -> None:
