"""Combined table-level execution strategy implementation."""
...
class CombinedTableExecutionStrategy(TableExecutionStrategy):
    """Executes regular `combined` variant jobs for a table."""
    ...
    def execute_table(
        ...
        logger.debug(
            "CombinedTableExecutionStrategy: выполнение table plan "
